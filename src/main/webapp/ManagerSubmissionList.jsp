                                    ...
                                    <div class="page-container">
                                        ...
                                        <div class="header-section">
                                            <div class="header-title">
                                                ...
                                                <p>Reviewing pending submissions for Department ID: <strong>
                                                        <%= manager.getDeptId() %>
                                                    </strong></p>
                                            </div>
                                                        ...
                                                        <% if (list==null || list.isEmpty()) { %>
                                                            <tr>
                                                                <td colspan="6" class="empty-state">
                                                                    ...
                                                                    <p>No pending claims found for Department <%=
                                                                            manager.getDeptId() %>.</p>
                                                                    <p style="font-size: 0.85rem; margin-top: 5px;">
                                                                        Great job! You're all caught up.</p>
                                                                </td>
                                                            </tr>
                                                            <% } else { for (Submission s : list) { String
                                                                ...
                                                                <tr>
                                                                    <td class="col-id">#<%= s.getSubmissionId() %>
                                                                    </td>
                                                                    <td class="col-emp">
                                                                        <i class="fa-regular fa-user"
                                                                            style="color:#9ca3af; margin-right:6px;"></i>
                                                                        <%= s.getEmployeeId() %>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td class="col-amount">RM <%= String.format("%.2f",
                                                                            s.getAmount()) %>
                                                                    </td>
                                                                    <td style="text-align: right;">
                                                                        <a href="ReviewClaim.jsp?id=<%= s.getSubmissionId() %>"
                                                                            class="btn-review">
                                                                            Review <i
