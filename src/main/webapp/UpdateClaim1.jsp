                                                ...
                                                <div class="form-grid">
                                                    ...
                                                    <div class="form-group full-width">
                                                        ...
                                                        <select name="diagnosis">
                                                            <option value="flu" <%="flu" .equals(diagnosis) ? "selected"
                                                                : "" %>>Flu</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="arrivalDest">
                                                                <option value="Ayer Keroh" <%="Ayer Keroh"
                                                                    .equals(arrivalDest) ? "selected" : "" %>>Ayer Keroh
                                                                </option>
                                                                <option value="Kajang" <%="Kajang" .equals(arrivalDest)
                                                                    ? "selected" : "" %>>Kajang</option>
                                                                <option value="Simpang Ampat" <%="Simpang Ampat"
                                                                    .equals(arrivalDest) ? "selected" : "" %>>Simpang
                                                                    Ampat</option>
                                                                <option value="Petaling Jaya" <%="Petaling Jaya"
                                                                    .equals(arrivalDest) ? "selected" : "" %>>Petaling
                                                                    Jaya</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
