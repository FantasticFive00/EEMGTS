    ...
    <%@ page import="model.Employee" %>
        <%@ page session="true" %>
            ...
            <% Employee emp=(Employee) session.getAttribute("employee"); if (emp==null) {
                ...
                (submissionId==null) { response.sendRedirect("ViewClaim.jsp"); return; } String
                        ...
                        <% try { Class.forName("org.postgresql.Driver"); conn=DriverManager.getConnection(dbURL, dbUser,
                                        ...
                                        <% if ("Overtime".equalsIgnoreCase(type)) { %>
                                            ...
                                            <% } else if ("Medical".equalsIgnoreCase(type)) { %>
                                                ...
                                                <% } else if ("Travel".equalsIgnoreCase(type)) { %>
                                                    ...
                                                    <div class="info-group">
                                                        <label>Rate</label>
                                                        <div class="value">RM <%= rs.getDouble("RATEPERKM") %>/km</div>
                                                    </div>
                                                    <% } %>
                                    </div>
                            ...
                            <% } else { %>
                                ...
                                <% } } catch (Exception e) { e.printStackTrace(); } finally { if (rs !=null) try {
                                    rs.close(); } catch (SQLException e) {} if (ps !=null) try { ps.close(); } catch
